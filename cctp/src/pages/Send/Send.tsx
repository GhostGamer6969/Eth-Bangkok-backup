  ...
  return (
    <>
      <div className="send-page-container">
        <h1 className="title">Transfer USDC across chains</h1>
        <p className="description">
        CeleriZ's Cross-Chain Transfer Protocol enables USDC to flow seamlessly between blockchains without requiring any asset conversion. The protocol operates entirely on-chain and in a permissionless environment, ensuring efficient and decentralized transfers.
        </p>
